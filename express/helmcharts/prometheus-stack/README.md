...
```console
# Helm
$ helm install prometheus-stack application/charts/prometheus-stack -n monitoring
```
#TODO Build Ansible and Flux config for auto-deployment
...
```console
# Helm
$ helm upgrade prometheus-stack application/charts/prometheus-stack -n monitoring
```
